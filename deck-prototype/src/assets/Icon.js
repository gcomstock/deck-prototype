...
const IconComponent = ({ name = 'placeholder', fill = '#000', size = 'medium'}) => {
  let Icon = iconsByName[name];
  const finalSize = iconSizes[size] + 'px';

  if(typeof Icon === 'undefined') {
    Icon = placeholder;
  }
  return <Icon style={{fill: fill, width: finalSize}} />;
};
